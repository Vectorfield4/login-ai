export const investorsPage = {
  ...
  ogDescription:
    "Invest in an AI studio with delivered cases: 9 AI directions, 7 live projects, funds for servers, hardware, and talent.",
  traction: {
    title: "Traction in numbers",
    0: "AI directions in our portfolio",
    1: "Turnkey services",
    2: "Delivered cases",
    3: "Industries where we already work",
  },
  market: {
  ...
  marketSize: {
    ...
    0: { label: "Global AI market by 2030", value: "$1.8T" },
    1: { label: "Yearly market growth", value: "≈30%" },
    2: { label: "Companies adopting AI", value: "~70%" },
    3: { label: "Directions in our portfolio", value: "9" },
    4: { label: "Engineers on the team", value: "12+" },
  },
  thesis: {
    title: "What we are building",
    0: {
      title: "A product inside the studio",
      text: "Services fund today, a product builds valuation for tomorrow. We grew on turnkey projects and reuse ready blocks: the agentic core, the video pipeline, the monitoring module. Every new case costs ten to fifteen percent less because part of the work is already done.",
    },
    1: {
      title: "Retention over one-off sales",
      text: "Half of our revenue is subscriptions and support, not a single release. A client pays for results, and while results stay measurable the contract renews. That lowers acquisition costs and makes cash forecasts predictable.",
    },
    2: {
  ...
  competitors: {
    title: "Why us instead of the alternatives",
    columns: ["Approach", "AI is the company focus", "Project start", "Pricing"],
    rows: [
      {
        name: "Login AI",
        cell0: "AI is our only focus",
        cell1: "2–3 weeks",
        cell2: "Quote before start, code stays with client",
        highlight: true,
      },
      {
        name: "In-house IT team",
        cell0: "AI is one task among ten",
        cell1: "Hiring takes 3–6 months",
        cell2: "Payroll and infrastructure on staff",
      },
      {
        name: "System integrator",
        cell0: "AI bundled with legacy",
        cell1: "2–4 month project",
        cell2: "Above-market rates",
      },
      {
        name: "Freelancers",
        cell0: "No validation or SLA",
        cell1: "Depends on availability",
        cell2: "Unpredictable outcome",
      },
    ],
  },
  quote: {
    text: "We do not sell compute discounts or hype around flagship models. We sell engineering no chatbot can do: design, validation, and adoption. The model market is volatile; the demand for engineers who ship AI is not.",
  },
  allocation: {
    title: "Where the funds go",
    0: "Servers and hardware",
  ...
  model: {
    ...
    0: {
      title: "First revenue stream: services",
      text: "Turnkey projects bring cash from the first quarter. We lock the quote before start and the deadline before release; thanks to reusable components a typical launch takes two or three weeks. For an investor that means a predictable cash flow with no long 'dead' development phase.",
    },
    1: {
  ...
  terms: {
    ...
    0: { label: "Round", value: "Pre-seed · 30M ₽" },
    1: { label: "Investor stake", value: "5–15%" },
    2: { label: "Exit horizon", value: "3–5 years" },
    3: { label: "Main cost item", value: "Servers, hardware, team" },
    4: { label: "Reporting", value: "Quarterly" },
  },
